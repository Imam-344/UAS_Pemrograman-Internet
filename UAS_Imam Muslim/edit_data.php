...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update_query = "UPDATE buku SET title = '$new_title', author = '$new_author', published_year = '$new_publish_year', isbn = '$new_isbn' WHERE id = '$id_to_update'";
...
if (isset($_GET['id'])) {
    ...
    $edit_query = "SELECT id, title, author, published_year, isbn FROM buku WHERE id = '$id_to_edit'";
...
<body>
    ...
    <section>
        ...
        <form method="post" action="">
            ...
            <input type="text" id="published_year" name="published_year" value="<?php echo $edit_published_year; ?>" required>
