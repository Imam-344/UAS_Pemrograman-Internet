...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $new_published_year = sanitize($_POST['published_year']);
    $new_isbn = sanitize($_POST['isbn']);

    // Menggunakan prepared statement untuk mencegah SQL Injection
    $insert_query = $conn->prepare("INSERT INTO perpustakaan (title, author, published_year, isbn) VALUES (?, ?, ?, ?)");
    $insert_query->bind_param("ssss", $new_title, $new_author, $new_published_year, $new_isbn);
